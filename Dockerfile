...
RUN apt-get install -y  make php5 apache2 rsync wget

RUN mkdir /ultra-fast-laser-spectroscopy-iitk

COPY src/ /ultra-fast-laser-spectroscopy-iitk/src

WORKDIR ./ultra-fast-laser-spectroscopy-iitk/src
